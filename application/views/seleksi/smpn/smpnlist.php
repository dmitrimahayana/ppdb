	<div class="isi isi1">
					<blockquote class="putih">
						<legend>Lihat Hasil Seleksi Tahap I SMP</legend>
						<form method="GET" action="<?php echo site_url('seleksi1/smpnlist') ?>" class="form-inline">
						    <div class="control-group">
						    	<select name="id_diterima_di" class="dinput" style="width:60%">
		                            <option value="">  # Pilihan SMP # </option>
		                            <?php foreach($query_combosmp->result() as $row): ?>
	...
	<div class="isi isi1">
		<blockquote class="putih">
             <strong>Halaman : </strong><?php echo $this->pagination->create_links();?><br>
					...
					<h2>Data Hasil Seleksi Tahap I SMP di <?php echo $query_arraysmp[$id_diterima_di]; ?></h2>
					<?php else : ?>
					<b>Hasil Ranking Sementara Berdasarkan Data Masuk di <?php echo $query_arraysmp[$id_diterima_di]; ?></b>
					<?php endif; ?>
					<br />
					<br />
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td><?php echo $row->NO_UJIAN; ?></td>
	                                ...
	                                <td><a href="<?php echo site_url().'/pendaftar/smpnnodaf/'. $row->NO_UJIAN; ?>">
						<?php echo $row->NAMA; ?>
	                            </a></td>
