	<div class="isi isi1">
					<blockquote class="putih">
						<legend>Lihat Hasil Seleksi Tahap I SMA</legend>
						<form method="GET" action="<?php echo site_url('seleksi1/smanlist') ?>" class="form-inline">
	...
	<div class="isi isi1">
		<blockquote class="putih">
             <strong>Halaman : </strong><?php echo $this->pagination->create_links();?><br>
					...
					<h2>Data Hasil Seleksi Tahap I SMA di <?php echo $query_arraysma[$id_diterima_di]; ?></h2>
					<?php else : ?>
					<b>Hasil Ranking Sementara Berdasarkan Data Masuk di <?php echo $query_arraysma[$id_diterima_di]; ?></b>
					<?php endif; ?>
					<br />
					<br />
