			<div class="isi isi1">
				Rekap Pagu Penerimaan Siswa Baru Kabupaten Sidoarjo 2011
			</div>
			<div class="isi isi1">
					<h3 class="text-center"><strong>SMP Negeri</strong></h4>
					<table class="table table-striped table3">
						<tr>
							<td><strong>Kode</strong></td>
							<td><strong>Nama Sekolah</strong></td>
							<td><strong>Pagu</strong></td>
							<td><strong>Nilai Min</strong></td>
							<td><strong>Nilai Max</strong></td>
						</tr>
						<tr>
                            <td>02</td>
			...
			<div class="isi isi1">
					<h3 class="text-center"><strong>SMA Negeri</strong></h4>
					<table class="table table-striped table3">
						<tr>
							<td><strong>Kode</strong></td>
							<td><strong>Nama Sekolah</strong></td>
			...
			<div class="isi isi1">
					<h3 class="text-center"><strong>SMK Negeri</strong></h4>
					<table class="table table-striped table3">
						<tr>
							<td><strong>Kode</strong></td>
							<td><strong>Nama Sekolah</strong></td>
							...
							<td><strong>Nilai Max</strong></td>
                               ...
                               <tr>
                                ...
                                <tr>
                                    <td>7402</td>
                                    <td>SMK Negeri 3 Buduran</td>
                                    <td>TEKNIK INSTALASI PERMESINAN KAPAL</td>
                                    <td>36</td>
                                    <td>51.08</td>
                                    <td>62.04</td>
                                </tr>
